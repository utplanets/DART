...
# of CESM using a B compset in which CAM, CLM, MOSART, CICE and POP are
# active but DART is only active in the POP component.
#
# The initial POP and CICE states come from Who Kim's multi-century JRA-55
# forced run, g210.G_JRA.v14.gx1v7.01.
#
# The initial CAM, CLM and MOSART come from the CAM6 DART Reanalysis.
#
...
# this case, assimilate.csh, which configures DART to run filter.
#
